...
@section('import-excel')
    ...
    <div class="mt-5">
        <a href="{{ route('export.discards') }}" class="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-lg">
...
@section('table')
    <h1 class="text-3xl font-semibold mb-6">Tabla de libros descartados</h1>
        ...
        <table class="bg-white border border-gray-300 rounded-lg overflow-hidden" style="width: 105%">
            <thead class="bg-gray-800 text-white">
                <tr>
                    ...
                    <th class="py-3 px-4">Cantidad de descartes</th>
                </tr>
            </thead>
