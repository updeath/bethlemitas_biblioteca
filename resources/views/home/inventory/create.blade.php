    ...
    <form class="grid grid-cols-1 md:grid-cols-2 gap-4" action="{{ route('inventory.store') }}" method="POST" enctype="multipart/form-data" style="width:100%">
        ...
        <div class="sm:pl-3 pt-7" >
            ...
            <div class="mb-3">
                ...
                <input id="publication_date" name="publication_date" value="{{ old('publication_date') }}" class="w-full shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="number" min="1800" max="2099" placeholder="YYYY">
